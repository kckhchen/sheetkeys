const Commands = {
  ...
  commands: {
    ...
    colorCellBlack: {
      fn: SheetActions.colorCellBlack.bind(SheetActions),
    ...
    colorTextBlack: {
      fn: SheetActions.colorTextBlack.bind(SheetActions),
    ...
    colorTextWhite: {
      fn: SheetActions.colorTextWhite.bind(SheetActions),
    ...
    colorTextLightYellow3: {
      fn: SheetActions.colorTextLightYellow3.bind(SheetActions),
      name: "Color text yellow",
      group: "formatting",
      nonRepeatable: true,
      hiddenFromHelp: true,
    },
    colorTextLightCornflowerBlue3: {
      fn: SheetActions.colorTextLightCornflowerBlue3.bind(SheetActions),
    ...
    colorTextLightPurple: {
      fn: SheetActions.colorTextLightPurple.bind(SheetActions),
      name: "Color text purple",
      group: "formatting",
      nonRepeatable: true,
      hiddenFromHelp: true,
    },
    colorTextLightRed3: {
      fn: SheetActions.colorTextLightRed3.bind(SheetActions),
      name: "Color text red",
      group: "formatting",
      nonRepeatable: true,
      hiddenFromHelp: true,
    ...
    colorTextLightGray2: {
      fn: SheetActions.colorTextLightGray2.bind(SheetActions),
  ...
  defaultMappings: {
    "normal": {
      ...
      "colorTextBlack": ";•t•B",
      "colorTextWhite": ";•t•w",
      "colorTextLightYellow3": ";•t•y",
      "colorTextLightCornflowerBlue3": ";•t•b",
      "colorTextLightPurple": ";•t•p",
      "colorTextLightRed3": ";•t•r",
      "colorTextLightGray2": ";•t•g",
      "fontSizeNormal": ";•f•n",
      "fontSizeLarge": ";•f•l",
      "fontSizeSmall": ";•f•s",
      "freezeRow": ";•f•r",
